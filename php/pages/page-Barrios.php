...
<a class="regresar" href="?page=Comunidades&rel=<?php echo $comunidad->municipio_id?>">Regresar</a>
         ...
         <h3 class="portlet-title">
          Listado de Barrios de la Comunidad de <?php echo $comunidad->descripcion;?>
          <?php if($obj->TienePermiso('CREAR')){ ?>
          <button type="button" class="btn btn-primary" id="btn-nuevo-<?php echo $obj->modelo;?>" >Nuevo Barrio </button>
          <?php } ?>
