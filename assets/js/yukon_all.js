...
/* plugins */
    ...
    yukon_vector_maps = {
        ...
        p_dashboard: function(colores_js_mapa,municipios_js_mapa) {
            if($('#world_map_vector').length) {
                $('#world_map_vector').vectorMap({
                    ...
                    onRegionClick: function(event,code){
                        //alert('');
                        //var map = $('#world_map_vector').vectorMap('get', 'mapObject');
                        console.log(code);
                        //window.location.href="?page=mapas&municipio="+code;
                    ...
                    series: {
                        regions: [{
                            scale: colores_js_mapa,
                            attribute: 'fill',
                            values: municipios_js_mapa
                                 }]
                    }/*,
