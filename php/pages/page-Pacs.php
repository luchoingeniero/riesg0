<div class="portlet">
        <h3 class="portlet-title">
          ...
          <button type="button" class="btn btn-primary" id="btn-nuevo-<?php echo $obj->modelo;?>" >Nuevo PAC </button>
          <?php } ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label for="descripcion" class="control-label">Año:</label>
            <input type="text" class="form-control" required="required" id="anio" name="anio">
          </div>
