<div class="portlet">
        ...
        <h3 class="portlet-title">
          ...
          <button type="button" class="btn btn-primary" id="btn-nuevo-<?php echo $destino?>" >Nuevo <?php echo $obj->label?> </button>
          <?php } ?>
 ...
 <form id="formObjeto<?php echo $destino?>" method="post" action="?page=GuardarObjeto<?php echo $destino?>">
