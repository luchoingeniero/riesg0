                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <table class="table table-yuk">
                                        ...
                                        <tbody>
                                        <?php foreach ($municipios_list as $key => $mun) {
                                            ?>
                                                <tr>
                                            <td class="cw"><span class="icon_pin" style="color:<?php echo $mun->color ?>"></td>
                                            <td><?php echo $mun->descripcion?></td>
                                            <td><?php echo $mun->censos?></td>
                                        </tr>
